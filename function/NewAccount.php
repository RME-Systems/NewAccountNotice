...
if(isset($_POST['submit'])){
	...
	if(empty($FormData['domain'])){
        ...
        $sql = mysqli_query($connect, "INSERT INTO `hosting_account`(`account_username`, `account_password`, `account_key`, `account_domain`, `account_status`, `account_date`, `account_for`, `account_sql`, `account_creation`) VALUES ('".$Result['username']."','".$FormData['password']."','".$FormData['username']."','".$Result['domain']."','3','".$Result['date']."','".$ClientInfo['hosting_client_key']."','NULL','".$Result['time']."')");
				if($sql){
